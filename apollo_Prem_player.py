...
def addsongs():
    ...
    temp_song = filedialog.askopenfilenames(
        initialdir=r"D:/20XW27_Package/Apollo/Songs", title="Choose a song", filetypes=(("mp3 Files", "*.mp3"),))


    # loop through every item in the list to insert in the listbox
    for s in temp_song:
        s = s.replace("D:/20XW27_Package/Apollo/Songs", "")
...
def Play():
    ...
    song = rf'D:/20XW27_Package/Apollo/Songs{song}'
...
def Previous():
    ...
    temp2 = rf'D:/20XW27_Package/Apollo/Songs{temp2}'
...
def Next():
    ...
    temp = rf'D:/20XW27_Package/Apollo/Songs{temp}'
